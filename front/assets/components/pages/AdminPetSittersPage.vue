    ...
    <div class="mx-auto max-w-6xl px-6 py-8">
      <div class="mb-6">
        ...
        <p class="text-sm text-zinc-400 mt-1">
          Every pet sitter across all owners · {{ petSitters?.total ?? 0 }} total
        </p>
      </div>
            ...
            >
              ...
              <td class="px-4 py-3">
                ...
                <div class="rounded border border-amber-500/20 bg-amber-500/5 px-2 py-1 text-xs inline-block">
                  ...
                  <span
                    v-if="ps.ownerUsername"
                    class="text-amber-400/60 ml-1"
                  >({{ ps.ownerUsername }})</span>
                </div>
              </td>
      ...
      <!-- Pagination -->
      <div
        v-if="petSitters && petSitters.totalPages > 1"
      ...
      >
        ...
        <button
          :disabled="page >= petSitters.totalPages"
          class="rounded-lg border border-zinc-700 px-4 py-1.5 text-sm text-zinc-400 hover:bg-zinc-800 disabled:opacity-40 transition"
          @click="page++"
        >
          Next →
