    ...
    <div class="mx-auto max-w-6xl px-6 py-8">
      <div class="mb-6">
        ...
        <p class="text-sm text-zinc-400 mt-1">
          Every cat across all owners · {{ cats?.total ?? 0 }} total
        </p>
      </div>
      ...
      >
        ...
        >
          ...
          <div class="shrink-0 rounded-lg border border-amber-500/30 bg-amber-500/5 px-3 py-1.5 text-xs">
            <p class="text-amber-400/60 font-medium mb-0.5">
              Owner
            </p>
            <p class="text-amber-300 font-mono">
              {{ cat.ownerEmail ?? cat.ownerId }}
            </p>
            <p
              v-if="cat.ownerUsername"
